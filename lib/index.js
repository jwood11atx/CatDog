...
window.onload = () => {
  ...
  function loadAssets() {
    ...
    promises.push(loader.loadSound('epicMusic', '../CatDog/audio/battle.mp3'));
    promises.push(loader.loadSound('startScreenMusic', '../CatDog/audio/caketown.mp3'));
    promises.push(loader.loadSound('battleMusic', '../CatDog/audio/happy.mp3'));
    promises.push(loader.loadSound('winMusic', '../CatDog/audio/annulet.wav'));
  ...
  Promise.all(promises).then(function() {
    ...
    gameState = 'menu';
    document.getElementById('bg-layer').style.position = "absolute";
    document.getElementById('fg-layer').style.position = "absolute";
    document.getElementById('hud-layer').style.position = "absolute";
    stopLoadingMusic()
  }).then(function() {
    playLoadingMusic(true);
  })
  ...
  function playLoadingMusic(force) {
    if (!loadingMusicStarted || force) {
